...
| --- | --- | --- | --- |
| stillpay-tn10 | `C:\Users\<user>\stillpay-tn10` | `npm test` | **pass** |
...
| peglab-stp | `C:\Users\<user>\peglab-stp` | `npm test` + HTTP `:8765` | **pass**, **200**. Genesis not submitted (needs ≥2.01 tKAS) |
| peglab-poc | `C:\Users\<user>\peglab-poc` | `npm test` | **pass** |
| stillpay-mainnet | `C:\Users\<user>\stillpay-mainnet` | `npm test` | **pass**. Broadcast left off. This wallet is TN10, not mainnet |
| kaspa-x402 | `C:\Users\<user>\src\kaspa-x402` | `npm test` (RC1 suite) | **pass** (EXIT=0). Live funded proof **not** run this pass |
...
| kns | `C:\Users\<user>\kns` | `go test ./...` | **FAIL** `TestContractSourcesDoNotReadForeignState`: `KasName.sil` uses `readInputState` (silverscript #234) |
| kns-spec | `C:\Users\<user>\kns-spec` | `go test ./...` | **pass** |
| kaspa-data-vault | `C:\Users\<user>\kaspa-data-vault` | `go test ./...` | **pass** |
...
| wallet-integration | `C:\Users\<user>\wallet-integration` | `npm test` | **pass**. Inject only; never asks for this seed |
| kaachat-desktop | `C:\Users\<user>\kaachat-desktop` | `npm test` | **pass** |
| argent-xai | `Documents\kaspa\argent-xai` | `check.ps1` | **pass** (pins match freeze) |
| dagknight-test-grok | `C:\Users\<user>\dagknight-test-grok` | `cargo test` | **8 pass / 0 fail** |
